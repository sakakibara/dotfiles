...
T.describe("core.pack load reason tracking", function()
  ...
  T.it("event triggers tag the firing event", function()
    ...
    vim.wait(100, function() return pack._load_reason["lazy-evt-r"] ~= nil end, 5)
  ...
  T.it("ft triggers tag the matching filetype", function()
    ...
    vim.cmd("enew")
    vim.bo.filetype = "lua"
    vim.wait(100, function() return pack._load_reason["lazy-ft-r"] ~= nil end, 5)
...
T.describe("core.pack lazy triggers", function()
  T.it("event trigger loads plugin on autocmd fire", function()
    ...
    vim.wait(100, function() return loaded end, 5)
    T.truthy(loaded)
  end)
...
T.describe("core.pack deps + on_load", function()
  ...
  T.it("on_load registered for a lazy plugin fires on load", function()
    ...
    vim.wait(100, function() return fired end, 5)
    T.truthy(fired)
  end)
end)
