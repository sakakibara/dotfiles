...
set -gx LANG "<machine.locale | default "en_US.UTF-8">"
set -gx LC_ALL "<machine.locale | default "en_US.UTF-8">"

# Set oracle language
set -gx NLS_LANG "<machine.nls_lang | default "AMERICAN_AMERICA.AL32UTF8">"
...
if set -q IS_WSL; or set -q WSL_DISTRO_NAME
    set -gx TZ /usr/share/zoneinfo/<machine.timezone | default "Japan">
    set -gx DISPLAY ":0"
end
        ...
        switch $THEME_FAMILY
            case catppuccin
                switch $THEME_VARIANT
                    case latte
                        set -gx FZF_DEFAULT_OPTS '--color=bg+:#ccd0da,bg:#eff1f5,spinner:#dc8a78,hl:#d20f39 --color=fg:#4c4f69,header:#d20f39,info:#8839ef,pointer:#dc8a78 --color=marker:#dc8a78,fg+:#4c4f69,prompt:#8839ef,hl+:#d20f39'
                    case frappe
