# dotfiles shell helpers for PowerShell, the analog of .zfunc/dotfiles and
# .config/fish/functions/dotfiles.fish. Source this from your $PROFILE:
#
...
function dotfiles {
    ...
    $script = Get-Command 'dotfiles.ps1' -CommandType ExternalScript -ErrorAction Stop
    & $script.Source @args
    $rc = $LASTEXITCODE
